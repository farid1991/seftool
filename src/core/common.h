...
enum connect_mode_e { SERIAL_CONNECTION, USB_CONNECTION };
...
enum phone_type_e {
	...
	ERICSSON_T28,
	ERICSSON_T29,
	ERICSSON_MP, // EMP: Ericsson Mobile Platform
};

enum avr_device_name_e {
	ERICSSON_T39_T65_R520,
	ERICSSON_T68,
	SE_T200,
	SE_T230_T290,
	SE_T300_T310,
...
enum chipset_type_e { PHONE_AVR, PHONE_AVR_ARM, PHONE_ARM, PHONE_NEW_ARM, PHONE_Z80 };
